/**
 * logger.ts — Простое логирование для pi-sub расширения.
 * 
 ...
 *      - Стало: LOG_FILE = ~/.pi/logs/pi-sub.log
...
/**
 * v13: Путь к лог-файлу — ~/.pi/logs/pi-sub.log
 * 
...
function getLogFile(): string {
  ...
  return join(home, ".pi", "logs", "pi-sub.log");
}
