...
import { extractText } from "../igorpi-context-tools/utils/text-extractor.js";

// ---- igorpi-memory imports ----
import { MemoryDatabase, getSessionMemory, type SessionMemory } from "../igorpi-memory/index.js";

// ---- ФАЗА 6: Импорт утилиты для генерации compaction summary ----
import { generateCompactionDetailedSummary, type CompactionMeta } from "../igorpi-context-tools/utils/compaction-summary.js";
...
${factLines.join("\n")}`;
      ...
      console.error(`[igorpi-subagents] ❌ Failed to get relevant facts:`, err);
    }
  }
